...
ENTRYPOINT ["./openrmf-api-scoring"]

LABEL org.opencontainers.image.source=https://github.com/Cingulara/openrmf-api-scoring
LABEL org.opencontainers.image.authors="dale.bingham@cingulara.com"
LABEL org.opencontainers.image.description="This is the score generating internal API to generate checklist scores for OpenRMF OSS"
LABEL org.opencontainers.image.vendor="Cingulara LLC and Tutela LLC"
LABEL org.opencontainers.image.title="OpenRMF OSS Score internal API"